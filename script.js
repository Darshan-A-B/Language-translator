$(document).ready(function(){
    ...
    let countries = ['german', 'british', 'irish', 'russian','hindi', 'emoji', 'quenya', 'boston', 'austrian', 'mandarian','valyrian', 'dothraki'];
...
function countryApiUrl(country){
    ...
    if (country == 'german' || country == 'russian' || country == 'hindi'){
